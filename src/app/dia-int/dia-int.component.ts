...
@Component({
  selector: 'app-dia-int',
  templateUrl: './dia-int.component.html',
  styleUrls: ['./dia-int.component.css']
})
export class DiaIntComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DiaIntComponent>,
