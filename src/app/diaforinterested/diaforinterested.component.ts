...
@Component({
  selector: 'app-diaforinterested',
  templateUrl: './diaforinterested.component.html',
  styleUrls: ['./diaforinterested.component.css']
})
export class DiaforinterestedComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DiaforinterestedComponent>,
  ...
  getDetails()
  {
    var x = this.crudService.SETINTPP;
    
  }
  getListServiceReport()
  {
    console.log("Service-Report List Fetch");
     this.servRef1 = this.db.list('user', ref => ref.orderByKey().equalTo(this.crudService.SETINTPP));
